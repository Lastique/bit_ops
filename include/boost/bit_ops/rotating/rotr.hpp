...
template< typename T >
inline T rotr(T value, unsigned int count, std::integral_constant< unsigned int, 1u >) BOOST_NOEXCEPT
{
...
template< typename T >
inline T rotr(T value, unsigned int count, std::integral_constant< unsigned int, 2u >) BOOST_NOEXCEPT
{
...
template< typename T >
inline T rotr(T value, unsigned int count, std::integral_constant< unsigned int, 4u >) BOOST_NOEXCEPT
{
...
template< typename T >
inline T rotr(T value, unsigned int count, std::integral_constant< unsigned int, 8u >) BOOST_NOEXCEPT
{
...
inline T rotr(T value, unsigned int count, std::integral_constant< unsigned int, N >) BOOST_NOEXCEPT
{
...
template< typename T >
inline typename std::enable_if< std::is_integral< T >::value && std::is_unsigned< T >::value, T >::type rotr(T value, unsigned int count) BOOST_NOEXCEPT
{
    return bit_ops::detail::rotr(value, count, std::integral_constant< unsigned int, sizeof(T) >());
}
