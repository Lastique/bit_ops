 ...
 * \file countl_one.hpp
 *
 * This header defines \c countl_one algorithm, which counts the number of consecutive
 * most significant one bits in an integer.
 */

#ifndef BOOST_BIT_OPS_COUNTING_COUNTL_ONE_HPP_INCLUDED_
...
/*!
 * \brief Returns the number of consecutive most significant one bits in \a value
 *
...
#endif // BOOST_BIT_OPS_COUNTING_COUNTL_ONE_HPP_INCLUDED_
